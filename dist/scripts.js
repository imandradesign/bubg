...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function fetchPlayerNames() {
        return __awaiter(this, void 0, void 0, function () {
            var response, data, allPlayers, playerListElement, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("https://docs.google.com/spreadsheets/d/1G97cC4k_gf1gKlNIJ56X2cAUJl9K5lbTzozbCZSZnwA/gviz/tq?tqx=out:csv")];
                    case 1:
                        response = _a.sent();
    ...
    // Attach the fetch function to button click hopefully
